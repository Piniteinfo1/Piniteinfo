        ...
        <div class="row">
            <div class="col-lg-6">
                  <div class="timeline p-4 block mb-4">
                    <div class="tl-item">
                        <div class="tl-dot" ><a class="tl-author" href="#" data-abc="true"><span class=" avatar circle gd-info" style="height:90px; width: 90px"><img src="https://asset.targetfurniture.co.nz/thumb/VLD50LCM13/1_04502f6a58eb.jpg" alt="."></span></a></div>
                        <div class="tl-content">
                            <div class="">Order placed <a href="#" data-abc="true">@google</a> Store</div>
                            <div class="tl-date text-muted mt-1">27-July-2022</div>
                        </div>
                    </div>
                    <div class="tl-item">
                        <div class="tl-dot"><a class="tl-author" href="#" data-abc="true"><span class=" avatar circle gd-info" style="height:90px; width: 90px"><img src="https://asset.targetfurniture.co.nz/thumb/VLD50LCM13/1_04502f6a58eb.jpg" alt="."></span></a></div>
