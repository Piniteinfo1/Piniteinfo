...
<head>
    ...
    <title>Register Page - Design Alley</title>
                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="text-center mb-2"> Vendor Registration</h4>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                             <form method="POST" action="{{route('register') }}">
                                                @csrf
                                                        ...
                                                        <div class="form-group  mb-50">
                                                            <label for="inputlastname4">Mobile Number</label>
                                                            <input name="mobile" type="number" class="form-control" id="inputlastname4" placeholder="phone number">
                                                        </div>
                                                    ...
                                                    <div class="form-group mb-50">
                                                        <label for="password" class="col-md-4 col-form-label text-md-end">{{ __('Confirm ') }}</label>

                                                        <div class="col-md-50">
                                                            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Enter Password" name="password_confirmation" required autocomplete="new-password">
                                                    ...
                                                    <button type="submit" name="submit" class="btn btn-primary glow position-relative w-100">SIGN UP<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                                </form>
                                                <hr>
