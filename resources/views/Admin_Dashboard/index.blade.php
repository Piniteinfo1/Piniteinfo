                        ...
                        <div class="col-xl-4 col-md-6 col-12 dashboard-visit">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h4 class="card-title">Visits of 2021</h4>
                                            ...
                                            <div class="card text-center">
                                                <div class="card-content">
                                                    <div class="card-body py-1">
                                                        ...
                                                        <div class="text-muted line-ellipsis">All Products</div>
                                                        <h3 class="mb-0">{{$ProductsCount[0]->ProductsCount}}</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card text-center">
                                                <div class="card-content">
                                                    <div class="card-body py-1">
                                                        ...
                                                        <div class="text-muted line-ellipsis">All Designs</div>
                                                        <h3 class="mb-0">{{$DesignsCount[0]->DesignsCount}}</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between">
                                                <div class="list-left d-flex">
                                                    ...
                                                    <div class="list-content">
                                                        ...
                                                        <small class="text-muted d-block">{{$ProductsCount[0]->ProductsCount}} New Products</small>
                                                    </div>
                                                </div>
                                                <span>{{$ProductsCount[0]->ProductsCount}}</span>
                                            </li>
                                            <li class="list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between">
                                                <div class="list-left d-flex">
                                                    <div class="list-icon mr-1">
                                            ...
                                            <li class="list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between">
                                                <div class="list-left d-flex">
                                                    ...
                                                    <div class="list-content">
                                                        <span class="list-title">Total Desigs</span>
                                                        <small class="text-muted d-block">{{$DesignsCount[0]->DesignsCount}}</small>
                                                    </div>
                                                </div>
                                                <span>{{$DesignsCount[0]->DesignsCount}}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="d-flex market-statistics-1">
                                                        ...
                                                        <div class="statistics-data my-auto">
                                                            ...
                                                            <div class="statistics-date">
                                                                ...
                                                                <small class="text-muted">May 12, 2021</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-inline-block">
                                                    ...
                                                    <div class="d-flex mb-75 market-statistics-2">
                                                        ...
                                                        <div class="statistics-data my-auto">
                                                            ...
                                                            <div class="statistics-date">
                                                                <i class="bx bx-radio-circle font-small-1 text-success mr-25"></i>
                                                                <small class="text-muted">Jul 26, 2021</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
