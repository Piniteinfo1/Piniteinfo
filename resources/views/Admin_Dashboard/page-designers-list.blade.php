                                    ...
                                    <div class="table-responsive">
                                        <table id="users-list-datatable" class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$Designer->id}}</td>
                                                    <td><a href="html/ltr/vertical-menu-template/page-users-view.html">{{$Designer->email}}</a>
                                                    </td>
                                                    <td>{{$Designer->name}}</td>
                                                    <td>{{$Designer->created_at}}</td>
                                                    <td>Verified</td>
                                                    <td>designer</td>
                                                    @if($Designer->isactive == 1)
                                                    <td><span class="badge badge-light-success">Active</span></td>
                                                    @else
                                                    <td><span class="badge badge-light-success">INActive</span></td>
                                                    @endif
                                                    
                                                    <td><a href="{{route('Admin-user-edit', $Designer->id)}}"><i class="bx bx-edit-alt"></i></a></td>
                                                    <td><a href="{{route('Admin-houseowner-View', $Designer->id)}}"><i class="fa fa-eye"></i></a></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
