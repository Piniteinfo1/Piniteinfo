            ...
            <nav>
                <ul class="menu-aside">
                    <li class="menu-item active">
                        <a class="menu-link" href="{{route('VendorDashboard')}}">
                    ...
                    <li class="menu-item has-submenu">
                        ...
                        <div class="submenu">
                            <a href="{{route('VendorProductsList')}}">Product List</a>
                            <a href="{{route('VendorProductsview')}}">Product grid</a>
                           <!-- <a href="page-products-grid-2.html">Product grid 2</a> -->
                            <!-- <a href="{{route('vendorcategories')}}">Categories</a> -->
                        </div>
                    </li>
                    <li class="menu-item has-submenu">
                        ...
                        <div class="submenu">
                            <a href="{{route('vendororderslist')}}">Order list 1</a>
                 ...
                 <!--   <li class="menu-item has-submenu">
                     ...
                     <li class="menu-item">
                        <a class="menu-link" href="{{route('vendor_addproduct')}}">
                   ...
                   <li class="menu-item has-submenu">
                        ...
                        <div class="submenu">
                            <a href="{{route('vendorcategories')}}">Add Category </a>
                    ...
                    <li class="menu-item has-submenu">
                        ...
                        <div class="submenu">
                            <a href="{{route('editprofile')}}">Profile Details</a>
                            <a href="{{route('bussinessdetails')}}">Bussiness Details</a>
